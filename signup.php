    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($user_name) && !empty($password) && !is_numeric($user_name)) {
            ...
            if (mysqli_stmt_num_rows($check_stmt) > 0) {
                echo '<script>alert("Mail already exists. Please use a different mail.");</script>';
            } else {
                ...
                <div class="card rounded-3">
                    <form method="post" class="card-body p-4" id="taskForm">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="h2 mb-0">Sign Up</span>
                        ...
                        <div class="list-group rounded-0">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary" ame="Signup"
