...
if (isset($_POST['create']) && !empty($title)) {
    ...
    $created = date("Y-m-d");
    $query = "INSERT INTO tasks (list_id, title,  created) VALUES (?, ?, ?)";
    $stmt = mysqli_prepare($con, $query);
    mysqli_stmt_bind_param($stmt, "iss", $list_id, $title, $created);
    ...
    if (isset($_POST['changedCheckbox'])) {
        ...
        $query = "UPDATE tasks SET completed = CASE WHEN completed = 0 THEN 1 ELSE 0 END, finished = CURDATE() WHERE id = ?";
...
<head>
    ...
    <title><?php echo  list_title($list_id, $con) . " | TodoApp"; ?></title>
            ...
            <div class="col col-lg-8 col-xl-6">
                <div class="card rounded-3">
                    <form method="post" class="card-body p-4" id="taskForm">
                        ...
                        <p class="mb-2"><span class="h2 me-2">
                                <?php echo  list_title($list_id, $con); ?>
                            </span> </p>
                        ...
                        <div class="list-group rounded-0">
                            <?php loop_tasks($list_id,$con); ?>
                        </div>

                        <div class="divider d-flex align-items-center my-4">
                            <p class="text-center mx-3 mb-0" style="color: #a2aab7;">Add Task</p>
                        </div>
                        ...
                        <div class="input-group mb-3" style="    width: 80%;
                            ...
                            <div class="input-group-append">
                                <button class="input-group-text" id="basic-addon2" type="submit" name="create" value="create">Add</button>
                            </div>
                        </div>
                    </form>
                </div>
